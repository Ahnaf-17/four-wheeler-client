    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex rounded-xl items-center left-0   top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] h-full ">
                    <div className='text-white space-y-7 w-1/2 pl-12'>
                        ...
                        <p>There are many variations of passages fo available but the majority hae suffered alternation in some form</p>
                        <div className=''>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                <img src={img3} className="w-full rounded-xl" /><img src={img1} className="w-full rounded-xl" />
                <div className="absolute flex rounded-xl items-center left-0   top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] h-full ">
                    <div className='text-white space-y-7 w-1/2 pl-12'>
                        <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p>There are many variations of passages fo available but the majority hae suffered alternation in some form</p>
